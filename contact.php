...
<form method="post" class="generic_form" action="<?php echo "http://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>" id="contactform">
<fieldset>
<p class="fields"><label for="bx_name">Name</label> <input type="text" name="bx_name" id="bx_name" value="<?php echo $bx_name; ?>" tabindex="1" class="field" /></p>
<p class="fields"><label for="bx_email">Email</label> <input type="text" name="bx_email" id="bx_email" value="<?php echo $bx_email; ?>" tabindex="2" class="field" /></p>
<p class="fields"><label for="bx_url">Url</label> <input type="text" name="bx_url" id="bx_url" value="<?php echo $bx_url; ?>" tabindex="3" class="field" /> <em>Optional</em></p>
<p class="fields"><label for="bx_subject">Subject</label> <input type="text" name="bx_subject" id="bx_subject" value='<?php echo $bx_subject; ?>' tabindex="4" class="field" /></p>
<p class="fields"><label for="bx_message">Message</label> <textarea name="bx_message" id="bx_message" cols="45" rows="10" tabindex="5" class="field"><?php echo $bx_message; ?></textarea></p>
<div class="clear"></div>
<p class="submit_fields"><input type="submit" name="submit" value="Submit" class="button" tabindex="6" /></p>
</fieldset>
</form>
